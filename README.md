...
4.  (Optional) By default, this script doesn't check for `.desktop` files in the `xsessions` folder. If you use any other display managers like sddm, add a `dwm.desktop` file (see below) in the `xsessions` folder:
