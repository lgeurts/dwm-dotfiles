...
This repository comprises an assortment of modular scripts and configuration files built upon Arch and suckless. Its objective is to deliver a stable, clutter-free, and ergonomic desktop environment tailored for advanced users.
