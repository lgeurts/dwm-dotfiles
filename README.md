...
This repository comprises an assortment of my scripts and configuration files built upon [Arch Linux](https://archlinux.org) & [Suckless](https://suckless.org). Its objective is to deliver a stable, clutter-free, and ergonomic desktop environment tailored for advanced users.
