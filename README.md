...
4.  (**Optional**) By default, this script does not check for any `.desktop` files in the `xsessions` folder. If you use any other display manager(s), add a `dwm.desktop` file (see below) in the `xsessions` folder:
