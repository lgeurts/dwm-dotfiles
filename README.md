...
4.  (***Optional***) By default, this script does not check for any `.desktop` files in the `xsessions` folder. When using another display manager, add a `dwm.desktop` file (see below) in the `xsessions` folder:
