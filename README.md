...
4.  (***Optional***) By default, `script.sh` does not check for `.desktop` files in the `xsessions` folder. When using another display manager, place a `dwm.desktop` file (see below) in the `xsessions` folder:
