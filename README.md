...
4.  (Optional) By default, this script does n0t check for any `.desktop` files in the `xsessions` folder. If you use any other display manager(s) like sddm, add a `dwm.desktop` file (see below) in the `xsessions` folder:
