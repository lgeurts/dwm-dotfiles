...
All updates and enhancements aim to avoid big breaking changes, thus fully aligning with the rolling-release nature of the underlying arch system, while requiring less maintenance.
