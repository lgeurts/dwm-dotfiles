...
This repository comprises an assortment of modular scripts and configuration files built upon [Arch Linux](archlinux.org) and [suckless](suckless.org) dwm. Its objective is to deliver a stable, clutter-free, and ergonomic desktop environment tailored for advanced users.
...
![Clean desktop](https://github.com/lgeurts/dwm-dotfiles/blob/main/assets/17-12-2015-01.png)
![Busy desktop](https://github.com/lgeurts/dwm-dotfiles/blob/main/assets/17-12-2025-02.png)
